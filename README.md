...
This case actually passes only if there is no formattings appended in DOCX, XLSX, PPTX, but completely fails in the cases of using formats in _*between*_ or _*in*_ the sentences of DOCX, XLSX, PPTX file inputs.
